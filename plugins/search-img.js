...
cmd({
  ...
  try {
    ...
    if (!_0x3207b0) {
      return _0x2ac5cb("*Please provide search keywords for the image. Eg MidKingX*");
    }
    ...
    for (let _0xecb4cf = 0x0; _0xecb4cf < Math.min(_0x82a454.length, 0x5); _0xecb4cf++) {
      ...
      if (_0x58b5b7.images_url) {
        await _0x1a9409.sendMessage(_0x163393, {
          ...
          'caption': "*© Gᴇɴᴇʀᴀᴛᴇᴅ ʙʏ ᴊᴏsʜᴜᴀᴍᴀᴍʙᴏ*" 
        }, {
          'quoted': _0x59fdb9
        });
      }
