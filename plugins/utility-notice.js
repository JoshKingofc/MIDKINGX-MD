...
const OWNER_ID = "263716729222@s.whatsapp.net"; // Replace with the owner's WhatsApp number in the correct format
...
cmd({
  ...
  try {
    ...
    if (sender !== OWNER_ID) {
      return reply("*[❌] Ooops You are not authorized to add notices, only Mr JoshKingx can.*");
    }
...
cmd({
  ...
  try {
    ...
    let noticeMessage = "⟣┄〔 𝗠𝗜𝗗𝗞𝗜𝗡𝗚𝗫 𝗨𝗣𝗗𝗔𝗧𝗘𝗦 〕┅⟢\n\n";
    ...
    await conn.sendMessage(from, {
      image: { url: `https://i.postimg.cc/GmRpKL8j/1717623406802.jpg` }, // Replace with your image URL
